...
public class Names {
    ...
    public static class Blocks {
        ...
        public static final String CONCRETE_BRICKS_DARK = "concreteBricksDark";
        public static final String CONCRETE_ROCKS = "concreteRocks";
        public static final String CONCRETE_TEXTURED_BLOCKS = "concreteTexturedBlocks";
        public static final String OLD_CONCRETE_SQUARES = "oldConcreteSquares";
        public static final String CONCRETE_SQUARES = "concreteSquares";
